	...
	return function(e) {
			...
			void 0 === (a = "function" == typeof(i = function() {
				if ("object" === ("undefined" == typeof window ? "undefined" : r(window)) && void 0 !== document.querySelectorAll && void 0 !== window.pageYOffset && void 0 !== history.pushState) {
					...
					return document.addEventListener("DOMContentLoaded", function() {
						for (var e, t = document.querySelectorAll('a[href^="#"]:not([href="#"])'), 
						i = t.length; 
						e = t[--i];) e.addEventListener("click", n, !1)
					}), t
				}
				...
				return i(e, [{
					...
					value: function(e) {
						if (this.player.events.trigger("listswitch", {
							...
							this.player.template.heijiao.style.backgroundImage = t.cover ? "url('" + t.cover + "')" : "", 
					...
					value: function() {
						...
						this.player.template.naokuoPlayDisc.classList.remove("naokuo-play"),						
						this.player.pause(), 
						this.audios = [], 
						...
						this.player.template.heijiao.style.backgroundImage = "", 
				...
				return i(e, [{
					...
					value: function() {
						...
						this.player.template.skipBackButton.addEventListener("click", function() {
							...
							e.player.toggle()
						}), this.player.template.naokuoPlayButton.addEventListener("click", function() {
							if (document.body.clientWidth > 768 || !e.player.template.button.classList.contains("aplayer-pause")){
								e.player.toggle()
							}else{
								e.player.container.classList.toggle("Lyrics_appear")
							}
						})
					}
				}, {
			...
			e.exports = function(e) {
				...
				t += '\n    </ol>\n</div>\n<div class="aplayer-body">\n <div class="naokuo-song-wrap naokuo-ab-song">\n <div class="naokuo-song-disc">\n <div class="naokuo-song-turn">\n <div class="naokuo-song-rollwrap">\n <div class="naokuo-song-img a-circling" style="',
							...
							t += '\n                </button>\n            </div>\n        </div>\n    </div>\n    <div class="aplayer-notice"></div>\n    <div class="aplayer-miniswitcher"><button class="aplayer-icon">',
							t += s.right,
							t += '</button></div>\n</div>\n<div class="aplayer-list', a.listFolded && (t += " aplayer-list-hide"),
							t += '"', a.listMaxHeight && (t += ' style="max-height: ', t += o(a.listMaxHeight), t += '"'),
							t += ">\n    <ol", a.listMaxHeight && (t += ' style="max-height: ', t += o(a.listMaxHeight), t += '"'), t += ">\n        ", 
				l(n(1)(u({
					theme: a.theme,
					audio: a.audio,
			...
			var s = function() {
				...
				return i(e, [{
					...
					value: function() {
						...
						this.heijiao = this.container.querySelector(".naokuo-song-img"), 
						...
						this.naokuoPlayDisc = this.container.querySelector(".naokuo-song-disc"),
						this.naokuoPlayButton = this.naokuoPlayDisc
					}
				}]), e
			}();
			t.default = s
			...
			e.exports = '<svg xmlns="http://www.w3.org/2000/svg" version="1.1" viewBox="0 0 29 32"><path d="M9.333 9.333h13.333v4l5.333-5.333-5.333-5.333v4h-16v8h2.667v-5.333zM22.667 22.667h-13.333v-4l-5.333 5.333 5.333 5.333v-4h16v-8h-2.667v5.333333zM17.333 20v-8h-1.333l-2.667 1.333v1.333h2v5.333h2z"></path></svg>'
		}, function(e, t) {
			e.exports = '<svg xmlns="http://www.w3.org/2000/svg" version="1.1" viewBox="0 0 29 32"><path d="M9.333 9.333h13.333v4l5.333-5.333-5.333-5.333v4h-16v8h2.667v-5.333zM22.667 22.667h-13.333v-4l-5.333 5.333 5.333 5.333v-4h16v-8h-2.667v5.333"></path></svg>'
		}, function(e, t) {
			...
			var m = [],
				g = function() {
					function e(t) {
						if (function(e, t) {
							if (!(e instanceof t)) throw new TypeError("Cannot call a class as a function")
						}(this, e), this.options = (0, s.default)(t), 
							this.container = this.options.container, this.paused = !0,
							...
							this.container = this.options.container, 2 === this.options.lrcType || !0 === this.options.lrcType)
					...
					return i(e, [{
						...
						value: function() {
							var e = this;
							if (this.paused && (this.paused = !1, this.template.button.classList.remove("aplayer-play"), 
							this.template.button.classList.add("aplayer-pause"), this.template.button.innerHTML = "", 
							setTimeout(function() {
								e.template.button.innerHTML = o.default.pause
							}, 100), this.template.skipPlayButton.innerHTML = o.default.pause), 
							this.timer.enable("loading"), this.options.mutex)
						...
						value: function() {
							var e = this;
							this.setUIPlaying();
							this.template.naokuoPlayDisc.classList.add("naokuo-play");
						...
						value: function() {
							this.setUIPaused(), 
							this.audio.pause(), 
							this.template.naokuoPlayDisc.classList.remove("naokuo-play");
						}
					}, {
