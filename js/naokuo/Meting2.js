...
function _objectSpread(a) {
  for (var b = 1; b < arguments.length; b++) {
    var c = null == arguments[b] ? {} : arguments[b],
      d = Object.keys(c);
    "function" == typeof Object.getOwnPropertySymbols && (d = d.concat(Object.getOwnPropertySymbols(c)
      .filter(function (a) {
...
class MetingJSElement extends HTMLElement {
  ...
  _parse() {
    ...
    let a = this.api.replace(":server", this.meta.server)
    ...
    (async () => {
      try {
        ...
        console.error('Error occurred during fetching and processing data:', error);
        // 或者在此处处理错误，例如调用一个错误处理函数
