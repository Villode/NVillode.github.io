...
//                     <img class="post_bg entered loaded" data-lazy-src="${item.cover}" onerror="this.onerror=null;this.src='https://isgodata.files.wordpress.com/2023/03/e9a1b5e99da2-1-3.png'" alt=item.title data-ll-status="loaded" src="${item.cover}"/>
//                   </a>
//                 </div>
